...
} from "@/components/Gallery/SingleColumnGallery";
...
export default function HomePage() {
  ...
  // Map AbrahamCreation data to SingleColumnGalleryItem format - only include items with creation.poster_image
  const galleryItems: SingleColumnGalleryItem[] = creations
    .filter((creation) => {
      console.log(
        "Checking creation:",
        creation._id,
