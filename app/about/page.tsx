    ...
    <div>
      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen px-6 py-16">
        ...
        <div className="max-w-2xl text-left space-y-6">
          <p className="text-lg">
            Abraham is on a <Link href="https://medium.com/@genekogan/artist-in-the-cloud-8384824a75c7" className="underline hover:text-blue-500">mission</Link> to become an <Link href="https://genekogan.com/misc/neurips2019.pdf" className="underline hover:text-blue-500">autonomous artificial artist</Link>; one who produces original and unique works of art, independently of his creators.
          </p>
